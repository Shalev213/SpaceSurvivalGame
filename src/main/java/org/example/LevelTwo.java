...
//        this.teamName = teamName;
        ...
        super.levelInstructions = new LevelInstructions(super.windowWidth, super.windowHeight, "Level 2", " ", "src/main/java/resources/level2instructions.png", 100, windowHeight - 100);
